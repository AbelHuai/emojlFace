...
- (void)setEmojiText:(NSString*)emojiText
{
    ...
    if(self.attriRange.length>0){
    __weak typeof(self) weekSile=self;
    [self setText:mutableAttributedString afterInheritingLabelAttributesAndConfiguringWithBlock:^NSMutableAttributedString*(NSMutableAttributedString *mutableAttributedString1){
        mutableAttributedString1 = [[NSMutableAttributedString alloc]initWithAttributedString:mutableAttributedString];
        [mutableAttributedString1 addAttribute:NSFontAttributeName value:[UIFont fontWithName:@"Arial" size:16] range:NSMakeRange(0, mutableAttributedString.length)];
        [mutableAttributedString1 addAttribute:NSForegroundColorAttributeName value:[UIColor blackColor] range:NSMakeRange(0, mutableAttributedString.length)];
            [mutableAttributedString1 addAttribute:NSForegroundColorAttributeName value:[UIColor lightGrayColor] range:weekSile.attriRange];
        return mutableAttributedString1;
    }];
    }else
    {
